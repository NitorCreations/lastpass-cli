...
export CFLAGS="-O3 -march=native -fomit-frame-pointer -pipe -fPIC"

(cd curl-$CURL_VERSION && ./configure --enable-static --enable-static --disable-ldap --disable-rtsp --without-librtmp --without-libidn --with-nss && make -j 8) &
